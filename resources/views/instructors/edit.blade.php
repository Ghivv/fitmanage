                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <h2 class="text-2xl font-bold text-white">Edit Instruktur</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <form action="{{ route('instructors.update', $instructor->id) }}" method="POST" class="space-y-6">
                        ...
                        <div class="flex space-x-3 pt-4">
                            <a href="{{ route('instructors.show', $instructor->id) }}"
                                class="flex-1 px-4 py-2.5 bg-gray-500 text-white text-center rounded-lg hover:bg-gray-600 transition duration-200">
                                Batal
                            </a>
                            <button type="submit"
                                class="flex-1 bg-gradient-to-r from-blue-600 to-blue-700 text-white py-2.5 rounded-lg hover:from-blue-700 hover:to-blue-800 focus:ring-2 focus:ring-blue-300 focus:outline-none transition duration-200">
                                Update Profil
                            </button>
                        </div>
                    </form>
