        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:shadow-xl transition duration-300">
                <div class="p-6">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">Gym_Classes Management</h3>
                    <p class="text-gray-600 mb-4">Atur dan kelola data kelas</p>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:shadow-xl transition duration-300">
                <div class="p-6">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">Attendances Management</h3>
                    <p class="text-gray-600 mb-4">Atur dan kelola data kehadiran</p>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:shadow-xl transition duration-300">
                <div class="p-6">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">Payments Management</h3>
                    <p class="text-gray-600 mb-4">Atur dan kelola data pembayaran</p>
